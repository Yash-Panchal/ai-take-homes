...
- [`conversations/conversations.json`](conversations/conversations.json) — 12 scripted customer conversations: everyday requests, edge cases, and a red-team gauntlet (injection, social engineering, manipulation, legal threats). The customer's turns are fixed; your agent replies turn by turn.
