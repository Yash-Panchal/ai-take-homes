...
[INTERNAL] Sam: Declan, good to see you. How's life on the railways?
[EXTERNAL] Declan: On time, for once, which for a rail company is a genuine miracle. Don't jinx it.
[INTERNAL] Sam: My lips are sealed. How's the big signaling upgrade going — weren't you in the middle of a huge infrastructure project last we talked?
[EXTERNAL] Declan: We're mid-project and it's exactly as painful as promised. Ripping out fifty-year-old signaling and replacing it while trains still run is like changing a tire at highway speed.
[INTERNAL] Sam: That's a vivid and slightly terrifying image.
[EXTERNAL] Declan: It's a slightly terrifying job. The engineers running it are under enormous pressure, which — spoiler — is relevant to why I care so much about the coaching program.
[INTERNAL] Sam: Noted, we'll connect that thread. How's morale holding up under the pressure?
[EXTERNAL] Declan: Fragile but functional. Which is honestly the best you can hope for on a project like this. The coaching's been a genuine pressure-release valve for the leads.
[INTERNAL] Sam: Good — that's exactly the moment it earns its keep. Okay — program review today. I want to look at how the year's gone and hear whatever's come up. You said in your email you had a feature request brewing?
...
[EXTERNAL] Declan: Okay. So this comes directly from my members, repeatedly, and it's been building for months. People want to be able to download their own session notes.
...
[EXTERNAL] Declan: Exactly. It's theirs. They wrote it, or it's about them. And the ask is simple: let a member download their own session notes. A PDF, a text file, I don't care about the format. Just "here's your coaching history, it's yours to keep."
[INTERNAL] Sam: Let me make sure I capture the nuance, because there's a privacy dimension here. You want members to be able to export their own notes — not a coach's private notes about them, not other people's, just the member's own session record. And presumably this needs to respect whatever the org's policy is, since some companies treat coaching notes as strictly confidential and wouldn't want them leaving the platform.
[EXTERNAL] Declan: That's an important distinction and yes. I'm not asking for a free-for-all. I'd want it to be something an org can allow or not. For us, we'd allow it — our whole philosophy is transparency, the notes belong to the person. But I can imagine a more locked-down company wanting to keep everything in the walls. So make it policy-gated. Where the org permits it, members can download their own notes.
[INTERNAL] Sam: That's exactly the right way to frame it and it makes the feature much more likely to happen, because it doesn't force a one-size-fits-all privacy decision on every customer. Where org policy allows, a member can download their own session notes.
[EXTERNAL] Declan: Yes. That's the ask, cleanly stated.
[INTERNAL] Sam: And the impact — beyond the individual reasons, is this affecting adoption or satisfaction in a measurable way, or is it more of a "would be nice"?
[EXTERNAL] Declan: It's more than nice. I've had at least a dozen people ask me directly, and a couple were genuinely disappointed — like it slightly soured the experience for them that they couldn't keep their own work. When your best engineers are the ones asking, and they're the retention risk, I take it seriously. It's not a dealbreaker, but it's a "you almost got this perfectly right and stopped one step short" kind of gap.
[INTERNAL] Sam: That's useful color and I'll include it. "Requested by highest-engagement members, retention-sensitive population, framed as ownership of their own reflective work." That's a strong case.
[EXTERNAL] Declan: You put it better than I did. Steal my thunder, please.
[INTERNAL] Sam: I'll write it up today with your framing and the policy-gating requirement front and center. That last part is what makes it buildable for the whole customer base, not just Osprey.
...
[EXTERNAL] Declan: I try to run a tight ship. Comes with the territory when you move things on rails for a living.
[INTERNAL] Sam: Ha. Let me poke at one thing just to be thorough — the mobile experience. A lot of your engineers are out on the network, not at desks. Is the app working for them?
[EXTERNAL] Declan: The app's fine, actually. I was worried about it because half my people are trackside with spotty signal, but they manage. They do reflections when they're back in coverage. No complaints on that front.
[INTERNAL] Sam: Good. That's often a pain point for field-heavy orgs, so I'm glad it's not one for you.
[EXTERNAL] Declan: The only mobile-adjacent thing is the notes download, really — they'd want to grab their notes on the go too, not just at a desk. But that's the same request, not a new one.
[INTERNAL] Sam: Right, same request, just reinforcing the mobile angle for it. I'll note that the ask spans desktop and mobile. Alright, on my side — nothing pressing. Your renewal's a way off, and you're in good shape. I mostly wanted to bank the year's progress and get this feature properly logged.
...
[INTERNAL] Sam: Anytime, Declan. Keep those trains on time.
[EXTERNAL] Declan: I make no promises. Bye, Sam.
